...
![图 1-1. 左键](./01_left_click.webp) ![图 1-2. 右键](./02_right_click.webp)
...
![图 3-2. Harmor 的特殊通道](./05_harmor.webp)
...
![图 4-1. 单个音符可以修改颜色](./06_single_note.webp) ![图 4-2. 多个音符不可以修改颜色](./07_section.webp)
...
![图 4-3. Change color选项](./08_change_color.webp)
